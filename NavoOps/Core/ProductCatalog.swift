...
enum ProductCatalog {
    static let seed: [ProductApp] = [
        ...
        product("navokids", "NavoKids", "navokids", [.iOS, .android], .review, .review, "1.0", "12", .mixed, ready: true, tags: ["Kids", "Education"], appleBundleID: "com.kamilunavo.navokids", androidPackageID: "com.kamilunavo.navokids"),
        product("zweicheck", "ZweiCheck", "zweicheck", [.iOS, .android], .live, .internalTest, "1.0", "1", .subscription, ready: true, tags: ["Trust", "AI"], appleBundleID: "de.kamilunavo.zweicheck", androidPackageID: "de.kamilunavo.zweicheck"),
        product("arbeitsklar", "ArbeitsKlar", "arbeitsklar", [.iOS, .android], .review, .review, "1.0", "1", .subscription, ready: true, tags: ["Work", "Productivity"], appleBundleID: "de.kamilunavo.arbeitsklar", androidPackageID: "de.kamilunavo.arbeitsklar"),
        product("waermetakt", "WärmeTakt", "w-rmetakt", [.iOS, .android], .development, .development, "1.0", "1", .free, tags: ["SHK", "Heat Pump"], appleBundleID: "de.kamilunavo.waermetakt", androidPackageID: "de.kamilunavo.waermetakt"),
        product("reklaio", "Reklaio", "reklaio", [.iOS, .android], .live, .internalTest, "1.0", "1", .subscription, ready: true, tags: ["Business", "Complaints"], appleBundleID: "de.kamilunavo.reklaio", androidPackageID: "de.kamilunavo.reklaio"),
        ...
        product("kintaroq", "Kintaroq", "kamilunavo", [.iOS, .android], .review, .development, "1.0", "1", .mixed, ready: true, tags: ["Diagnostics", "AI"], appleBundleID: "com.kamilunavo.kintaroq", androidPackageID: "com.kamilunavo.kintaroq"),
        ...
        product("99-9", "99,9 %", "99-9", [.iOS, .android], .review, .review, "1.0.1", "2", .mixed, tags: ["Utility"], appleBundleID: "de.kamilunavo.ninenine", androidPackageID: "de.kamilunavo.ninenine"),
        ...
        product("navotap", "NavoTap", "onemoretap", [.iOS, .android], .live, .live, "1.0", "6", .free, ready: true, tags: ["Game", "Casual"], appleBundleID: "com.kamilunavo.onemoretap", androidPackageID: "com.kamilunavo.onemoretap"),
        ...
        product("lueftungscalc", "LüftungsCalc", "SHK", [.iOS, .android], .review, .development, "1.0", "1", .paid, tags: ["SHK", "Calculator"], appleBundleID: "de.kamilunavo.luftungscalc", androidPackageID: "de.kamilunavo.luftungscalc"),
        product("rohrcalc", "RohrCalc", "SHK", [.iOS, .android], .review, .development, "1.0", "1", .paid, tags: ["SHK", "Calculator"], appleBundleID: "de.kamilunavo.rohrcalc", androidPackageID: "de.kamilunavo.rohrcalc"),
        product("heizkoerpercalc", "HeizkörperCalc", "SHK", [.iOS, .android], .review, .development, "1.0", "1", .paid, tags: ["SHK", "Calculator"], appleBundleID: "de.kamilunavo.heizkorpercalc", androidPackageID: "de.kamilunavo.heizkorpercalc"),
        product("anlagencheck", "AnlagenCheck", "SHK", [.iOS, .android], .review, .development, "1.0", "1", .paid, tags: ["SHK", "Inspection"], appleBundleID: "de.kamilunavo.servicecheck", androidPackageID: "de.kamilunavo.servicecheck"),
